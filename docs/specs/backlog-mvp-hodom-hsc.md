...
| F2-12 | Portal mínimo para paciente/cuidador: próximas visitas, indicaciones, canal de reporte | M4 | Mejora adherencia y comunicación |
...
|-------------|-------------------|
| Stack tecnológico | Web app + PWA móvil vs app nativa. Recomendación: web app con PWA offline-first |
| Base de datos | PostgreSQL alineado con modelo integrado existente (`hodom-integrado-pg-v4.sql`) |
| Hosting | Local HSC vs cloud vs híbrido. Considerar conectividad rural |
| Autenticación | Integración con directorio institucional o gestión propia |
| Dispositivos en terreno | Smartphones personales vs institucionales |
